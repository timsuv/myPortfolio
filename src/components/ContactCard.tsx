...
export const ContactCard = () => {
  return (
    <div className="col-span-12 lg:col-span-3 border bg-zinc-800 border-gray-400 rounded-2xl p-3 flex flex-row md:flex-col items-center gap-3 lg:h-[560px] ">
      ...
      <section className="">
        <section className="text-xs flex flex-col gap-6 ">
          <div className="flex flex-row gap-3 items-center ">
            <a href="mailto:timsuvorov@icloud.com" className="text-green-500 border-t border-l rounded-md p-2 border-gray-500 hover:text-green-200">
              <svg
          ...
          <div className="flex flex-row gap-3 ">
            <a
              href="tel:0761772149"
              className="text-green-500 border-t border-l rounded-md p-2 border-gray-500 hover:text-green-200"
            >
              <svg
                xmlns="http://www.w3.org/2000/svg"
                viewBox="0 0 24 24"

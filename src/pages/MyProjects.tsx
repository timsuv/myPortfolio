        ...
        <div className="card">
          ...
          <div className="cardText">
            ...
            <p className="text-sm mt-2">
              ...
              possible for an user to login/register and rent a car. There are 3
              different locations with different cars. The user has the
            ...
            <div className="techStack">
              ...
              <div className="githubLink">
                <a href="https://github.com/timsuv/VeloRent">
                  <div>
                    <svg
                      xmlns="http://www.w3.org/2000/svg"
                      fill="currentColor"

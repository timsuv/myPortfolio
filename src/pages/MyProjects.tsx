            ...
            <div className="card">
              ...
              <div className="cardText">
                ...
                <p className="text-sm mt-2">
                  This is a console app project where i created an app where it
                  is possible for an user to login/register and rent a car.
                  There are 3 different locations with different cars. The user
                  has the possibility to update and cancel his bookings.
                </p>
                <div className="techStack">
                  ...
                  <div className="githubLink">
                    <a
                      href="https://github.com/timsuv/VeloRent"
                      target="_blank"
                    >
                      <div>
                        <svg
          ...
          <div className="p-1 flex flex-col gap-3 mt-5">
            <div className="card">
              ...
              <div className="cardText">
                ...
                <p className="text-sm mt-2">
                  I built a simple webshop using React, connected to my own
                  local minimal API to fetch products from a database. I also
                  implemented the cart logic in React, ensuring items are saved
                  in local storage and the cart updates dynamically.
                </p>
                <div className="techStack">
                  <h4 className="techStack__title">Tech Stacks</h4>
                  <ol className="techStack__list">
